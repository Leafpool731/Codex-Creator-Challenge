        ...
        <div className="mx-auto grid w-full min-w-0 max-w-[112rem] gap-8 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.35fr)_minmax(0,0.95fr)]">
          <section className="flex min-h-full min-w-0 max-w-xl flex-col px-1 py-2 sm:px-3 lg:py-8">
            ...
            <h1 className="mt-8 text-3xl leading-tight text-[#2f2723] [font-family:Georgia,Times,serif] sm:mt-12 sm:text-4xl lg:text-5xl">
              {t("headline")}
              <span className="block italic text-[#8f776d]">{t("headlineSub")}</span>
            </h1>

            <p className="mt-8 max-w-xl text-base leading-relaxed text-[#6f625a]">{t("intro")}</p>
            ...
            <div className="mt-12 grid gap-4">
              <FeatureCard title={t("feature16")} description={t("feature16Desc")} />
              <FeatureCard title={t("featureScore")} description={t("featureScoreDesc")} />
              <FeatureCard title={t("featureRec")} description={t("featureRecDesc")} />
            </div>

            <p className="mt-auto pt-16 text-xs text-[#9a8e86]">{t("copyright")}</p>
          </section>
